/* 
Crear un aray de 10 posiciones de numeros con valores pedidos por teclado. Mostrar el indice y el valor al que corresponde. Haz dos metodos, uno para rellenar valores y otro para mostrar 
*/
...
function ObtenerResultado() {
    for (let x = 0; x < 3; x++) {
        ...
        if (valor != "") {
            ...
            arreglo[x] = `<span class="text-danger`
        }
    }
    MostrarValores()
}
